drop table JBPM_ACTION  if exists cascade;
drop table JBPM_BYTEARRAY if exists cascade;
drop table JBPM_BYTEBLOCK if exists cascade;
drop table JBPM_COMMENT if exists cascade;
drop table JBPM_DECISIONCONDITIONS if exists cascade;
drop table JBPM_DELEGATION if exists cascade;
drop table JBPM_EVENT  if exists cascade;
drop table JBPM_EXCEPTIONHANDLER if exists cascade;
drop table JBPM_ID_GROUP if exists cascade;
drop table JBPM_ID_MEMBERSHIP  if exists cascade;
drop table JBPM_ID_PERMISSIONS if exists cascade;
drop table JBPM_ID_USER if exists cascade;
drop table JBPM_JOB if exists cascade;
drop table JBPM_LOG if exists cascade;
drop table JBPM_MODULEDEFINITION if exists cascade;
drop table JBPM_MODULEINSTANCE if exists cascade;
drop table JBPM_NODE if exists cascade;
drop table JBPM_POOLEDACTOR if exists cascade;
drop table JBPM_PROCESSDEFINITION if exists cascade;
drop table JBPM_PROCESSINSTANCE  if exists cascade;
drop table JBPM_RUNTIMEACTION if exists cascade;
drop table JBPM_SWIMLANE if exists cascade;
drop table JBPM_SWIMLANEINSTANCE if exists cascade;
drop table JBPM_TASK  if exists cascade;
drop table JBPM_TASKACTORPOOL if exists cascade;
drop table JBPM_TASKCONTROLLER if exists cascade;
drop table JBPM_TASKINSTANCE if exists cascade;
drop table JBPM_TOKEN if exists cascade;
drop table JBPM_TOKENVARIABLEMAP if exists cascade;
drop table JBPM_TRANSITION if exists cascade;
drop table JBPM_VARIABLEACCESS if exists cascade;
drop table JBPM_VARIABLEINSTANCE if exists cascade;
